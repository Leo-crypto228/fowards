...
Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique des modalités de mise à disposition du site et des services par Léo Le Guillou, éditeur du site futurfeed.com et de définir les conditions d’accès et d’utilisation des services par « l'Utilisateur ».
...
futurfeed.com  se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes CGU.

Article 1 : Les mentions légales

L’édition et la direction de la publication du site futurfeed.com est assurée par Léo Le Guillou, domicilié Druillat, l'Ain 01.
Numéro de téléphone est 0767913803
Adresse e-mail neyvo.entreprise@gmail.com.

L'hébergeur du site futurfeed.com est la société CloudFlare, dont le siège social est situé au 101 Townsend Street CA 94107 San Francisco États-Unis, avec le numéro de téléphone : +1 650-319-8930.

ARTICLE 2 : Accès au site

Le site futurfeed.com  permet à l'Utilisateur un accès gratuit aux services suivants :
Le site internet propose les services suivants :
FF est une plateforme en ligne permettant aux utilisateurs de partager du contenu, d’échanger et d’interagir autour de thématiques liées à l’entrepreneuriat, au développement personnel et aux expériences de vie.

Le site propose notamment :

la publication de contenus (textes, messages, réflexions) par les utilisateurs
l’interaction entre utilisateurs (likes, commentaires, échanges)
la consultation de contenus publiés par la communauté
la création et la gestion d’un compte utilisateur
des fonctionnalités visant à favoriser l’authenticité, le partage d’expérience et la motivation entre utilisateurs
...
Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la responsabilité de futurfeed.com. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service, même sans préavis.
...
Les sources des informations diffusées sur le site futurfeed.com sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.

Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle. Malgré des mises à jour régulières, le site futurfeed.com ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site.
...
Le site futurfeed.com ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.

La responsabilité du site ne peut être engagée en cas de force majeure ou du fait imprévisible et insurmontable d'un tiers.

ARTICLE 6 : Liens hypertextes

Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira du site futurfeed.com. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.

ARTICLE 7 : Cookies

L’Utilisateur est informé que lors de ses visites sur le site, un cookie peut s’installer automatiquement sur son logiciel de navigation.

Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l’ordinateur de l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site futurfeed.com. Les cookies ne contiennent pas d’information personnelle et ne peuvent pas être utilisés pour identifier quelqu’un. Un cookie contient un identifiant unique, généré aléatoirement et donc anonyme. Certains cookies expirent à la fin de la visite de l’Utilisateur, d’autres restent.

L’information contenue dans les cookies est utilisée pour améliorer le site futurfeed.com.
...
Œuvres originales, Article, Actualités ou articles d'opinion, Commentaires, réactions Discussions, forums.
