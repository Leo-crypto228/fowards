...
const MOCK_USERS: Record<string, MockUserData> = {
  thomasdubois: {
    ...
    streak: 87, objective: "Lancer mon SaaS",
    ...
    followers: 1240, following: 142, posts: 87,
    constance: 91, objectifsAccomplis: 8, daysOnFF: 112,
    evolutionData: [{ label: "S1", value: 20 }, { label: "S2", value: 34 }, { label: "S3", value: 41 }, { label: "S4", value: 58 }, { label: "S5", value: 63 }, { label: "S6", value: 77 }, { label: "S7", value: 87 }],
    followingList: [
      { name: "Emma Petit", avatar: "https://images.unsplash.com/photo-1582201942930-53fea460eeeb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200", objective: "Écrire un roman", followers: 2100, streak: 203, tags: ["#auteure"] },
      { name: "Sarah Martin", avatar: "https://images.unsplash.com/photo-1746632452765-05eeadb3c552?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200", objective: "Marathon en 6 mois", followers: 580, streak: 42 },
    ],
    followersList: [
      { name: "Marie Laurent", avatar: "https://images.unsplash.com/photo-1744040866609-2b8952159e1e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200", objective: "Apprendre le japonais", followers: 892, streak: 156 },
      { name: "Lucas Bernard", avatar: "https://images.unsplash.com/photo-1761358531297-614e4de53b85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200", objective: "Dev Full-Stack", followers: 670, streak: 31 },
    ],
  },
  marielaurent: {
    ...
    streak: 156, objective: "Apprendre le japonais",
    ...
    followers: 892, following: 68, posts: 156,
    constance: 88, objectifsAccomplis: 5, daysOnFF: 156,
    evolutionData: [{ label: "S1", value: 15 }, { label: "S2", value: 29 }, { label: "S3", value: 45 }, { label: "S4", value: 60 }, { label: "S5", value: 74 }, { label: "S6", value: 89 }, { label: "S7", value: 95 }],
    followingList: [
      { name: "Thomas Dubois", avatar: "https://images.unsplash.com/photo-1770894807442-108cc33c0a7a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200", objective: "Lancer mon SaaS", followers: 1240, streak: 87 },
    ],
    followersList: [
      { name: "Sarah Martin", avatar: "https://images.unsplash.com/photo-1746632452765-05eeadb3c552?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200", objective: "Marathon en 6 mois", followers: 580, streak: 42 },
    ],
  ...
  emmapetit: {
    ...
    streak: 203, objective: "Écrire un roman",
    ...
    followers: 2100, following: 310, posts: 203,
    constance: 96, objectifsAccomplis: 14, daysOnFF: 203,
    evolutionData: [{ label: "S1", value: 10 }, { label: "S2", value: 22 }, { label: "S3", value: 40 }, { label: "S4", value: 55 }, { label: "S5", value: 68 }, { label: "S6", value: 80 }, { label: "S7", value: 92 }],
    followingList: [],
    followersList: [
      { name: "Thomas Dubois", avatar: "https://images.unsplash.com/photo-1770894807442-108cc33c0a7a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200", objective: "Lancer mon SaaS", followers: 1240, streak: 87 },
    ],
...
const CHART_DATA: Record<EvoFilter, { label: string; value: number }[]> = {
  all:  [{ label: "S1", value: 20 }, { label: "S2", value: 34 }, { label: "S3", value: 41 }, { label: "S4", value: 58 }, { label: "S5", value: 63 }, { label: "S6", value: 77 }, { label: "S7", value: 87 }],
  "30d":[{ label: "J1", value: 42 }, { label: "J5", value: 48 }, { label: "J10", value: 53 }, { label: "J15", value: 57 }, { label: "J20", value: 61 }, { label: "J25", value: 67 }, { label: "J30", value: 72 }],
  week: [{ label: "L", value: 65 }, { label: "M", value: 68 }, { label: "Me", value: 64 }, { label: "J", value: 71 }, { label: "V", value: 70 }, { label: "S", value: 69 }, { label: "D", value: 72 }],
};
