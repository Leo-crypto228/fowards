...
E-mail, Nom et Prénom
La collecte et le traitement de ces données répond à la (aux) finalité(s) suivante(s) :  
gestion des comptes utilisateurs, fonctionnement de la plateforme communautaire, amélioration de l’expérience utilisateur, sécurité et modération des contenus, envoi d’informations liées au service.
...
Nous collectons les mails et les nom et prénom afin de créer et d’enregistrer le compte créé et de le répertorier.

Modèle réalisé sur LegalPlace.fr
Elles sont conservées par le responsable du traitement dans des conditions raisonnables de sécurité, pour une durée de : non déterminé. 
...
Le site Futurfeed est hébergé par :  
...
Téléphone (général) : +1 650-319-8930
...
Ces partenaires agissent en tant que sous-traitants et respectent la réglementation en vigueur relative à la protection des données personnelles.
    
Article 3.5 : Politique en matière de “cookies”
Le site FuturFeed utilise des cookies afin d’améliorer l’expérience utilisateur, mesurer l’audience et assurer le bon fonctionnement du site.
Ces cookies peuvent être déposés par FuturFeed ou par des services tiers tels que Cloudflare.
L’utilisateur peut configurer ses préférences en matière de cookies directement depuis son navigateur.
...
Les données à caractère personnelles sont collectées par FuturFeed, micro-entreprise, au capital de 0 euro, dont le numéro d’immatriculation est le [à compléter avec ton SIREN].
Le responsable du traitement des données à caractère personnel peut être contacté de la manière suivante :
Par téléphone, au : 07 67 91 38 03 
Par mail : leo.leguillou01@gmail.com
...
Le responsable du traitement (FuturFeed)
Adresse :01 Druillat, l’Ain en France
Email : leo.leguillou01@gmail.com
...
Pour exercer vos droits, veuillez adresser votre courrier à FuturFeed – 01 Druillat l’Ain France ou par mail à leo.leguillou01@gmail.com
Afin que le responsable du traitement des données puisse faire droit à sa demande, l’utilisateur peut être tenu de lui communiquer certaines informations telles que : ses noms et prénoms, son adresse e-mail ainsi que son numéro de compte.
Consultez le site cnil.fr pour plus d’informations sur vos droits.

Modèle réalisé sur LegalPlace.fr
ARTICLE 6 : CONDITIONS DE MODIFICATION DE LA POLITIQUE DE CONFIDENTIALITÉ
L’éditeur du site FuturFeed se réserve le droit de pouvoir modifier la présente Politique à tout moment afin d’assurer aux utilisateurs du site sa conformité avec le droit en vigueur.
...
La présente politique, éditée le 25/04/2026, a été mise à jour le 25/04/2026.
    Modèle réalisé sur LegalPlace.fr 
   </div>
  );
}